...
sources = [
    ("multi_class_20_40_60/results_real/samples_per_class_500", None, "real"),
    ("multi_class_20_40_60/results_synth_gaussian/samples_per_class_500", None, "synth"),
]
...
original_path = os.path.join(parent_dir, "multi_class_20_40_60/results_real/samples_per_class_500/results_original_resnet18.csv")
...
original_summary.to_csv("C:/Users/AT56170/Desktop/Codes/Machine Unlearning - Classification/Source_Free_Class_Unlearning/multi_class_20_40_60/original_averaged_results_resnet18.csv", index=False)
...
retrained_df = pd.read_csv(
    f"{parent_dir}/multi_class_20_40_60/results_real/samples_per_class_500/retrained/cifar100_resnet18_unlearning_summary.csv"
)
...
output_path = "C:/Users/AT56170/Desktop/Codes/Machine Unlearning - Classification/Source_Free_Class_Unlearning/multi_class_20_40_60/results_retrained_resnet18.csv"
...
def count_forget(s):
    ...
    Specifically checks for 20, 40, and 60 class counts.
    """
    ...
    if class_count in [20, 40, 60]:
        return class_count
    return 0  # Ignore other class counts for the table

# Adjust LaTeX table generation for proper handling of `Forget Class`
def make_multi_forget_table(stats_df: pd.DataFrame, out_path: str, dataset: str = "cifar100", model: str = "resnet18", forget_list=(20, 40, 60)):
    """
    ...
    """
    method_order = ["original", "retrained" ,"FT", "NG", "RL","BE", "NGFTW", "SCRUB", "SCAR"]  # Including "original"
    ...
    lines.append(r"\label{tab:ResNet-18_cifar100_multi_class_20_40_60}")
...
def main():
    ...
    out_merged = os.path.join(parent_dir, "multi_class_20_40_60/results_unlearning_resnet18.csv")
    ...
    out_best = os.path.join(
        parent_dir, "multi_class_20_40_60/results_unlearning_best_per_model_by_aus_resnet18.csv"
    )
    ...
    save_dir = os.path.join(
        parent_dir, "multi_class_20_40_60/best_per_dataset_method_source_resnet18"
    )
    ...
    out_total = os.path.join(
        parent_dir, "multi_class_20_40_60/results_total_resnet18.csv"
    )
    ...
    stats_path = os.path.join(parent_dir, "multi_class_20_40_60/results_mean_std_all_numeric_resnet18.csv")
    ...
    table_out = os.path.join(
        parent_dir,
        "multi_class_20_40_60/table_cifar100_resnet18_multiclass_20_40_60.tex",
    )
