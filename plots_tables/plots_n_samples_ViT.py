...
def plot_with_black_box(plot_obj, filename):
    ...
    plt.savefig(f"C:/Users/AT56170/Desktop/Codes/Machine Unlearning - Classification/Source_Free_Class_Unlearning/results_n_samples_ViT/{filename}.png", dpi=600, bbox_inches='tight')
    plt.savefig(f"C:/Users/AT56170/Desktop/Codes/Machine Unlearning - Classification/Source_Free_Class_Unlearning/results_n_samples_ViT/{filename}.pdf", dpi=600, bbox_inches='tight')
